  ...
  const [tasks, setTasks] = useState<Task[]>([
    {
      id: "1",
      name: "ACH Xpress",
      startDate: new Date(2025, 0, 1), // 1 de enero de 2025
      endDate: new Date(2025, 3, 15), // 15 de abril de 2025
      status: "external-dev",
    ...
    },
    {
      ...
      status: "external-dev",
      completed: true,
      details: "Implementación de imágenes de perfil en correos transaccionales para mejorar la experiencia de usuario",
      responsible: "Equipo de UX",
    },
    {
      id: "4",
      name: "Autenticación en 2 factores fase 1 (Correo y Celular)",
    ...
    {
      id: "5",
      name: "Correos con imagen de perfil CX, Seguridad, Cumplimiento",
    ...
    {
      id: "8",
      name: "Notificaciones para billeteras cobro comisiones",
                    ...
                    >
                      <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 -translate-y-full">
                        <div className="relative">
                          <div className="bg-red-500 text-white px-3 py-1 rounded-md whitespace-nowrap">Estás aquí</div>
